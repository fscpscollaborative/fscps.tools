Describe "Get-FSCPSADOAgent Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-FSCPSADOAgent).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter AgentPoolId' {
			$parameter = (Get-Command Get-FSCPSADOAgent).Parameters['AgentPoolId']
		...
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Get-FSCPSADOAgent).Parameters['Organization']
		...
		It 'Should have the expected parameter apiVersion' {
			$parameter = (Get-Command Get-FSCPSADOAgent).Parameters['apiVersion']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Get-FSCPSADOAgent).Parameters['Token']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-FSCPSADOAgent).Parameters['ProgressAction']
