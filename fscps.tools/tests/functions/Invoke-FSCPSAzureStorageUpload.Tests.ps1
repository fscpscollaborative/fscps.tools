Describe "Invoke-FSCPSAzureStorageUpload Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Invoke-FSCPSAzureStorageUpload).ParameterSets.Name | Should -Be 'Default', 'Pipeline'
		}
		
		It 'Should have the expected parameter AccountId' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageUpload).Parameters['AccountId']
		...
		It 'Should have the expected parameter AccessToken' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageUpload).Parameters['AccessToken']
		...
		It 'Should have the expected parameter SAS' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageUpload).Parameters['SAS']
		...
		It 'Should have the expected parameter Container' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageUpload).Parameters['Container']
		...
		It 'Should have the expected parameter Filepath' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageUpload).Parameters['Filepath']
		...
		It 'Should have the expected parameter ContentType' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageUpload).Parameters['ContentType']
		...
		It 'Should have the expected parameter Force' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageUpload).Parameters['Force']
		...
		It 'Should have the expected parameter DeleteOnUpload' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageUpload).Parameters['DeleteOnUpload']
		...
		It 'Should have the expected parameter EnableException' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageUpload).Parameters['EnableException']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageUpload).Parameters['ProgressAction']
	...
	Describe "Testing parameterset Default" {
		<#
		Default -Filepath
		Default -AccountId -AccessToken -SAS -Container -Filepath -ContentType -Force -DeleteOnUpload -EnableException -ProgressAction
		#>
	}
 	Describe "Testing parameterset Pipeline" {
		<#
		Pipeline -Filepath
		Pipeline -AccountId -AccessToken -SAS -Container -Filepath -ContentType -Force -DeleteOnUpload -EnableException -ProgressAction
		#>
	}
