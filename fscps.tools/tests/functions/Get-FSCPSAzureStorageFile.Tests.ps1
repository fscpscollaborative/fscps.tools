Describe "Get-FSCPSAzureStorageFile Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-FSCPSAzureStorageFile).ParameterSets.Name | Should -Be 'Default', 'Latest'
		}
		
		It 'Should have the expected parameter AccountId' {
			$parameter = (Get-Command Get-FSCPSAzureStorageFile).Parameters['AccountId']
		...
		It 'Should have the expected parameter AccessToken' {
			$parameter = (Get-Command Get-FSCPSAzureStorageFile).Parameters['AccessToken']
		...
		It 'Should have the expected parameter SAS' {
			$parameter = (Get-Command Get-FSCPSAzureStorageFile).Parameters['SAS']
		...
		It 'Should have the expected parameter Container' {
			$parameter = (Get-Command Get-FSCPSAzureStorageFile).Parameters['Container']
		...
		It 'Should have the expected parameter Name' {
			$parameter = (Get-Command Get-FSCPSAzureStorageFile).Parameters['Name']
		...
		It 'Should have the expected parameter DestinationPath' {
			$parameter = (Get-Command Get-FSCPSAzureStorageFile).Parameters['DestinationPath']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-FSCPSAzureStorageFile).Parameters['ProgressAction']
	...
	Describe "Testing parameterset Default" {
		<#
		Default -
		Default -AccountId -AccessToken -SAS -Container -Name -DestinationPath -ProgressAction
		#>
	}
