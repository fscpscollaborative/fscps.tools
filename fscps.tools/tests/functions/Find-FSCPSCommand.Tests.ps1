Describe "Find-FSCPSCommand Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Find-FSCPSCommand).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Pattern' {
			$parameter = (Get-Command Find-FSCPSCommand).Parameters['Pattern']
		...
		It 'Should have the expected parameter Tag' {
			$parameter = (Get-Command Find-FSCPSCommand).Parameters['Tag']
		...
		It 'Should have the expected parameter Author' {
			$parameter = (Get-Command Find-FSCPSCommand).Parameters['Author']
		...
		It 'Should have the expected parameter MinimumVersion' {
			$parameter = (Get-Command Find-FSCPSCommand).Parameters['MinimumVersion']
		...
		It 'Should have the expected parameter MaximumVersion' {
			$parameter = (Get-Command Find-FSCPSCommand).Parameters['MaximumVersion']
		...
		It 'Should have the expected parameter Rebuild' {
			$parameter = (Get-Command Find-FSCPSCommand).Parameters['Rebuild']
		...
		It 'Should have the expected parameter EnableException' {
			$parameter = (Get-Command Find-FSCPSCommand).Parameters['EnableException']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Find-FSCPSCommand).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -
		__AllParameterSets -Pattern -Tag -Author -MinimumVersion -MaximumVersion -Rebuild -EnableException -ProgressAction
		#>
	}
