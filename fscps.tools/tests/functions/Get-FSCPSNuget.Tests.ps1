Describe "Get-FSCPSNuget Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-FSCPSNuget).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Version -Type
		__AllParameterSets -Version -Type -Path -Force -ProgressAction
		#>
	}
