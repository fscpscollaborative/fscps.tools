Describe "Get-FSCPSADOTestCasesBySuite Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-FSCPSADOTestCasesBySuite).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter TestSuiteId' {
			$parameter = (Get-Command Get-FSCPSADOTestCasesBySuite).Parameters['TestSuiteId']
			$parameter.Name | Should -Be 'TestSuiteId'
		...
		It 'Should have the expected parameter TestPlanId' {
			$parameter = (Get-Command Get-FSCPSADOTestCasesBySuite).Parameters['TestPlanId']
		...
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Get-FSCPSADOTestCasesBySuite).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Get-FSCPSADOTestCasesBySuite).Parameters['Project']
		...
		It 'Should have the expected parameter apiVersion' {
			$parameter = (Get-Command Get-FSCPSADOTestCasesBySuite).Parameters['apiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-FSCPSADOTestCasesBySuite).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -
		__AllParameterSets -TestSuiteId -TestPlanId -Organization -Project -apiVersion -Token -ProgressAction
		#>
	}
