Describe "Invoke-FSCPSAzureStorageDownload Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Invoke-FSCPSAzureStorageDownload).ParameterSets.Name | Should -Be 'Default', 'Latest'
		}
		
		It 'Should have the expected parameter AccountId' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageDownload).Parameters['AccountId']
		...
		It 'Should have the expected parameter AccessToken' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageDownload).Parameters['AccessToken']
		...
		It 'Should have the expected parameter SAS' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageDownload).Parameters['SAS']
		...
		It 'Should have the expected parameter Container' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageDownload).Parameters['Container']
		...
		It 'Should have the expected parameter FileName' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageDownload).Parameters['FileName']
		...
		It 'Should have the expected parameter Path' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageDownload).Parameters['Path']
		...
		It 'Should have the expected parameter Latest' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageDownload).Parameters['Latest']
		...
		It 'Should have the expected parameter Force' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageDownload).Parameters['Force']
		...
		It 'Should have the expected parameter EnableException' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageDownload).Parameters['EnableException']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Invoke-FSCPSAzureStorageDownload).Parameters['ProgressAction']
	...
	Describe "Testing parameterset Default" {
		<#
		Default -FileName
		Default -AccountId -AccessToken -SAS -Container -FileName -Path -Force -EnableException -ProgressAction
		#>
	}
 	Describe "Testing parameterset Latest" {
		<#
		Latest -Latest
		Latest -AccountId -AccessToken -SAS -Container -Path -Latest -Force -EnableException -ProgressAction
		#>
	}
