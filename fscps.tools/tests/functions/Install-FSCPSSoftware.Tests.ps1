Describe "Install-FSCPSSoftware Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Install-FSCPSSoftware).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Name' {
			$parameter = (Get-Command Install-FSCPSSoftware).Parameters['Name']
		...
		It 'Should have the expected parameter Force' {
			$parameter = (Get-Command Install-FSCPSSoftware).Parameters['Force']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Install-FSCPSSoftware).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -Name -Force -ProgressAction
		#>
	}
