...
<#
    ...
    .EXAMPLE
        PS C:\> Restart-FSCPSEnvironment -All
        
        This will stop all services and then start all services again.
        
    .EXAMPLE
        PS C:\> Restart-FSCPSEnvironment -All -ShowOriginalProgress
...
#>
function Restart-FSCPSEnvironment {
